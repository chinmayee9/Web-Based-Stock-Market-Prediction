...
exec('python query3.py YHOO',$var_name1);
echo '<br><br><br><br><br><br><div id="inside"><font id="predict" color="white">The average stock price of Yahoo! in latest 1 year: $'.$var_name1[0].'</font></div>';
