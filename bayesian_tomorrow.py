...
def predict(data):
    ...
    for i in range(M):
        phi[i] = x ** i
    # Getting the sum of all phi_xn required for 1.72 and sum of all products of phi_xn and corresponding tn required for 1.70
    ...
    # Printing the values
    print round(t_predicted, 2)
    # return t_predicted


realtimePrices = getHistoricalData(sys.argv[1])
