...
exec('python query4.py YHOO',$var_name1);
echo '<br><br><br><br><br><br><div id="inside"><font id="predict" color="white">The lowest stock price for Yahoo! in the latest 1 year: $'.$var_name1[0].'</font></div>';
